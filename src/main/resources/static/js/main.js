...
async function getAddNewUserForm() {
    ...
    $('#addUserToDBButt').click(async () =>  {
        ...
        let username = newUserDBForm.find('#add-username').val();
        let surname = newUserDBForm.find('#add-surname').val();
...
async function editUser(modal, id) {
        ...
        let editUserFormContent = `
            <form class="form-group" id="editUser">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="usernameEdit" required name="username" value="${user.username}">
                        </div>
                        <div class="form-group">
                            <label for="surnameEdit" class="col-form-label">Surname:</label>
                            <input type="text" class="form-control" id="surnameEdit" required name="surname" value="${user.surname}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="roleBoxEdit" class="col-form-label">Select Role: </label>
    ...
    $("#editButton").on('click', async () => {
        ...
        let username = modal.find("#usernameEdit").val();
        let surname = modal.find("#surnameEdit").val();
    ...
    user.then(user => {
        let deleteUserFormContent = `
            <form class="form-group" id="editUser">
                        ...
                        <div class="form-group">
                            <label for="usernameEdit" class="col-form-label">Username:</label>
                            <input type="text" readonly="readonly" class="form-control" id="usernameEdit" required name="username" value="${user.username}">
                        </div>
                        <div class="form-group">
                            <label for="surnameEdit" class="col-form-label">Surname:</label>
                            <input type="text" readonly="readonly" class="form-control" id="surnameEdit" required name="surname" value="${user.surname}">
                        </div>
                        <div class="form-group">
                            <label for="ageEdit" class="col-form-label">Age:</label>
